...
const values = [
  ...
  },
  {
    ...
    title: "Commitment",
    description:
      "We stay true to our promises, maintaining integrity and focus to achieve success.",
  },
  {
    id: 4,
    number: "04",
    ...
    description:
      "Environmentally friendly garment restoration for a greener industry.",
  },
  {
    id: 5,
    number: "05",
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgb(220,38,38), rgb(239,68,68), rgb(220,38,38))",
          animation: "rotBGimg 3s linear infinite",
        }}
      ></div>

      {/* Inner white card */}
      <div className="relative bg-black rounded-lg m-[3px] p-6 h-full hover:shadow-lg transition-all duration-300">
        {/* Number badge */}
        ...
        {/* Content */}
        <div className="pt-6">
          <h3 className="text-xl font-bold text-white-900 mb-2">{value.title}</h3>
          ...
          <div className="col-span-1">
            ...
            >
              ...
              <p className="text-muted text-sm mt-4 leading-relaxed">
                The principles that shape our existence, guiding us through challenges
                in every garment we restore.
              </p>
            </motion.div>
          </div>

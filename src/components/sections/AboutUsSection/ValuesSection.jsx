        ...
        <div className="grid grid-cols-3 gap-6 items-start">
          ...
          <div className="col-span-1">
            <motion.div
              ...
              viewport={{ once: false }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">OUR</h2>
          ...
          {values.slice(0, 2).map((value, index) => (
            ...
            >
              <div className="relative bg-white border-2 border-red-200 rounded-lg p-6 hover:shadow-lg transition-all duration-300">
                {/* Number badge */}
